      ...
      <div className="grid grid-cols-12 min-h-screen ">
        ...
        <div className="col-start-4 col-end-10">
          ...
          <p className="bg-white p-2 rounded-b-md profile-about pb-2">
            &emsp; &emsp; We are twin brothers who are led by passion and curiosity for data science and machine learning. We were both deeply intrigued by the possibilities of AI and machine learning, and we thought that it would be a great idea to work on a project together. We came up with an idea to build a machine learning model that is interactive and also useful. After some thinking, we both decided that we should come up with ML models that can detect brain tumors in MRI scans as an effort to minimize misdiagnosis. <br />
            &emsp; &emsp; Brain tumor and its misdiagnosis is unfortunately an issue that has deeply affected our personal lives. Upon research, we discovered that one of the reasons why brain tumors are so dangerous is because of their generic symptoms and mysterious etiologies. These characteristics cause it to be difficult for patients and physicians to pinpoint and diagnose brain tumors until it has already progressed. <br />
            &emsp; &emsp; With our effort at creating machine learning models to detect brain tumors at earlier stages, we hope to someday save the tears and heartache that misdiagnosis can bring to families. We believe that with the power of AI, we can make a significant impact in the field of medical diagnostics. Our model leverages advanced neural networks, particularly convolutional neural networks (CNNs), to analyze MRI scans and identify potential brain tumors with high accuracy. <br />
            {/* &emsp; &emsp; Our journey was not without challenges. From collecting and preprocessing the data to training the model and fine-tuning its parameters, every step required meticulous attention to detail. We faced numerous obstacles, but our shared passion and determination kept us going. We collaborated closely, leveraging each other's strengths and supporting each other through the tough times. <br /> */}
            &emsp; &emsp; The results of our work have been promising. Our model has shown high accuracy in detecting brain tumors in MRI scans, and we continue to refine it to improve its performance further. We have also made our model interactive, allowing users to input their MRI scans and receive a diagnosis. This feature makes our tool accessible to a broader audience and empowers patients and physicians with a powerful diagnostic aid. <br />
            &emsp; &emsp; It's still too early to tell, but our ultimate goal is to integrate our model into the healthcare system, where it can be used as a supplementary tool for radiologists and medical professionals. We dare to picture a future where our technology can assist in early detection, leading to timely treatment and improved outcomes for patients. <br />
            &emsp; &emsp; We are incredibly proud of what we have accomplished so far, but we know that this is just the beginning. There is still much work to be done, and we are committed to continuing our research and development in this field. Our dream is to contribute to the fight against brain tumors and make a lasting impact on the lives of those affected by this devastating condition. <br />
            &emsp; &emsp; We hope that our story inspires others to explore the possibilities of AI and machine learning in healthcare. Together, we can harness the power of technology to make the world a better place.
          </p>
          ...
          <div className="grid grid-cols-8 gap-2 rounded-md profiles" >
            ...
            <div className="col-start-1 col-end-5 rounded-md profile-container bg-white">
              ...
              <div className="profile-description">
                <h2 className="h-72">
                  &emsp; &emsp; Hi, my name is Jeff, and I am currently a research assistant at Boston Children's Hospital. I graduated from Vanderbilt University with a Chemistry major, but decided
                  ...
                  &emsp; &emsp; I am having a lot of fun learning about this field, and this is one of the many more machine learning projects I plan to work on. On top of these projects, I am
                  ...
                  &emsp; &emsp; If you want to get to know about me more, please feel free to visit my personalized portfolio website! This is the first website I made by myself using NextJS:&nbsp;
            ...
            <div className="col-start-5 col-end-9 rounded-md profile-container bg-white">
              ...
              <div className="profile-description ">
                <h2 className="h-72">
                  &emsp; &emsp; Hello, my name is Sean, and I am currently studying Data Science at UC Irvine. I was initially studying Physics for the first 3 years of university, but decided quickly
                  to switch my major to data science after I fell in love with its never-ending possibilities and practicality in today's world led by data. <br />
                  &emsp; &emsp; My passion lies in building different machine learning models and applying them to real life application problems to come up with an optimized solution.
                  Thanks of my background in physics, I was able to pick up on the subject relatively easily and also understand concepts to a deeper degree.  <br />
                  &emsp; &emsp; My goal is to utilize my skills in data science to tackle pressing issues. My dream is to contribute to meaningful projects that have a lasting 
